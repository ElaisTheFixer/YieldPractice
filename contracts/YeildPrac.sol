/**
    ...
    Variable APY offered in form of token rewards - rewards have a vesting schedule for protocol health                           

    implemented fee system that is only active of interaction with the uni router
...
contract YieldPrac is ERC20, Ownable, YieldStaking {
    ...
    uint256 public upgradeFee = 0.2 ether;
    ...
    function initializePlans() public onlyOwner {
        _createPlans();
    }
